...
1. Make sure you have <a href="https://docs.docker.com/compose/install/" target="_blank">Docker compose</a> installed.
2. Start your docker instance, and run with your GitHub API key:

```
docker-compose run -e GITHUB_API_KEY=df0f649ad2761c2fabfa6a3cabd15c4eab8c5b03 --service-ports web
```
